        ...
        <div class="card bg-base-100 shadow-xl">
          <div class="card-body">
            <h2 class="card-title text-primary">
              <.icon name="hero-clock" class="w-6 h-6" /> Total Playtime
            </h2>
        ...
        <div class="card bg-base-100 shadow-xl">
          <div class="card-body">
            <h2 class="card-title text-secondary">
              <.icon name="hero-user-circle" class="w-6 h-6" /> Login Stats
            </h2>
        ...
        <div class="card bg-base-100 shadow-xl">
          <div class="card-body">
            <h2 class="card-title text-accent">
              <.icon name="hero-calendar-days" class="w-6 h-6" /> Account Info
            </h2>
            <p class="text-lg">
              Member Since: <span class="font-bold">{@stats.account_created}</span>
            </p>
          </div>
        </div>
        ...
        <div class="card bg-base-100 shadow-xl">
          <div class="card-body">
            <h2 class="card-title text-warning">
              <.icon name="hero-users" class="w-6 h-6" /> Characters
            </h2>
            <p class="text-lg">
              Total Characters: <span class="font-bold">{@stats.character_count}</span>
            </p>
            <p class="text-lg">
              Combined Levels: <span class="font-bold">{@stats.total_levels}</span>
            </p>
    ...
    <!-- Leaderboard Link -->
      <div class="mb-8 text-center">
        <.link navigate={~p"/leaderboard"} class="btn btn-primary btn-lg">
          <.icon name="hero-trophy" class="w-6 h-6" /> View Leaderboard
        </.link>
      </div>
