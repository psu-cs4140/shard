...
defmodule ShardWeb.MudGameLive do
  ...
  def handle_info({:healing_action, healer_name, healing_amount, target_name}, socket) do
    # Check if this healing is targeted at this player
    if String.downcase(target_name) == String.downcase(socket.assigns.character_name) do
      # Apply the healing to this player's health
  ...
  def handle_info({:poison_action, attacker_name, damage_amount, target_name}, socket) do
    # Check if this poison is targeted at this player
    if String.downcase(target_name) == String.downcase(socket.assigns.character_name) do
