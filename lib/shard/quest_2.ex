defmodule Shard.Quest2 do
  @moduledoc """
  Quest turn-in and reward processing functions.
  """
  ...
  def can_turn_in_quest?(user_id, quest_id) do
    ...
    case Shard.Characters.get_characters_by_user(user_id) do
      ...
      [character | _] ->
        ...
        with quest when not is_nil(quest) <- Shard.Quests.get_quest!(quest_id),
             true <- Shard.Quests.quest_in_progress_by_user?(user_id, quest_id) do
