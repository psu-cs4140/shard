defmodule Shard.Map.Zone do
  ...
  schema "zones" do
    field :name, :string
    # field :zone_id, :string  # Temporarily commented out
    field :slug, :string
  ...
  def changeset(zone, attrs) do
    ...
    |> cast(attrs, [
      :name,
      # :zone_id,  # Temporarily commented out
      :slug,
      :description,
      :zone_type,
      :min_level,
    ...
    |> validate_required([:name, :slug])  # Removed zone_id temporarily
    |> validate_length(:name, min: 2, max: 100)
    # |> validate_length(:zone_id, min: 2, max: 100)  # Temporarily commented out
    ...
    # |> unique_constraint(:zone_id)  # Temporarily commented out
